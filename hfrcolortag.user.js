...
class Post {
  ...
  refresh() {
    ...
    this.button.style.display         = ((this.isQuote && !displayQuote)   || !db.config.displayButton)          ? "none"  : "block";
    if (!this.isQuote) {
...
function checkQuote()           {checkParameter(this,2)}
function checkBackgroundPost()  {checkParameter(this,3)}
function checkBackgroundQuote() {checkParameter(this,4)}
...
inputFieldSettings.onkeyup   = (event) => {if (event.keyCode == 13) inputFieldSettings.save()};
  ...
  input.onchange      = function(event) {
    ...
    reader.onload = function () {
      try {
        ...
        //vérification de la cohérence du fichier importé
...
function checkQuoteSettings()           {checkParameterSettings(this,2)}
function checkBackgroundPostSettings()  {checkParameterSettings(this,3)}
function checkBackgroundQuoteSettings() {checkParameterSettings(this,4)}
